    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                .authorizeHttpRequests((requests) -> requests
                        ...
                        .requestMatchers("/manga/edit/{id}").hasAnyAuthority("ADMIN", "MangaModerator")
                        .requestMatchers("/manga/delete/{id}").hasAnyAuthority("ADMIN", "MangaModerator")
                        .requestMatchers("/genre/add").hasAnyAuthority("ADMIN", "MangaModerator")
                        .requestMatchers("/genre/edit/{id}").hasAnyAuthority("ADMIN", "MangaModerator")
                        .requestMatchers("/genre/delete/{id}").hasAnyAuthority("ADMIN", "MangaModerator")
                        .requestMatchers("/author/add").hasAnyAuthority("ADMIN", "MangaModerator")
                        .requestMatchers("/author/edit/{id}").hasAnyAuthority("ADMIN", "MangaModerator")
                        .requestMatchers("/author/delete/{id}").hasAnyAuthority("ADMIN", "MangaModerator")

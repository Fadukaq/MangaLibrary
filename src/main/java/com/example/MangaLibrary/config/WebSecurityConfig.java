    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                .authorizeHttpRequests((requests) -> requests
                        ...
                        .requestMatchers("/news/add").hasAnyAuthority("ADMIN", "NewsModerator")
                        .requestMatchers("/news/edit/{newsId}").hasAnyAuthority("ADMIN", "NewsModerator")
                        .requestMatchers("/news/delete/{newsId}").hasAnyAuthority("ADMIN", "NewsModerator")
